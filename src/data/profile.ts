...
export const profile = {
  ...
  bio: [
    'I build things that haven\'t been built before. For twenty years at Eaton Corporation, I\'ve had the rare privilege of taking ideas from a whiteboard — or a patent filing — all the way to products used by hundreds of thousands of people. Whether growing a software team from three engineers to forty-five, architecting a cloud IoT platform from scratch, or co-inventing a smart circuit breaker that spawned a $100M business, I\'ve always operated at the intersection of deep technical craft and strategic business thinking.',
    'My career has been defined by doing hard things in emerging spaces — IoT before it had a name, energy management before the grid was "smart," agentic AI workflows before most teams knew where to start. I\'m drawn to problems that require you to invent the solution, not just implement it. That means building not just the product, but the team, the process, the roadmap, and sometimes the market itself.',
...
export const competencies: Competency[] = [
  ...
  },
  {
    ...
    description: 'Led strategic initiatives generating $300M+ in incremental revenue. Evaluated acquisition targets, built monetization strategies, and represented Eaton at IEEE, SAE, and NEMA.',
    icon: 'trending-up',
  },
  {
